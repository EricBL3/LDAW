...
<body>
    <div class="bg-secondary text-white">
        ...
        <div class="text-center">
            <img src="/images/foto_profesional_Eric.jpg" class="img-fluid">
            <h2> Eric Fernando Torres Rodríguez</h2>
            <h2> A01700249 </h2>
        </div>
        ...
        <div class="accordion col-md-6 mx-auto" id="accordionExample">
            ...
            <div class="card">
                ...
                <div id="collapseOne" class="collapse" aria-labelledby="headingOne" data-parent="#accordionExample">
                    <div class="card-body">
                        Para control de versiones he utilizado: GitHub, GitLab y BitBucket.
                    </div>
                </div>
            </div>
            <div class="card">
                ...
                <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionExample">
                    <div class="card-body">
                        He utilizado la misma herramienta que te brinda GitLab pero tambien tengo experiencia con Trello
                    </div>
                </div>
            </div>
            <div class="card">
            ...
            <div class="card">
                ...
                <div id="collapse5" class="collapse" aria-labelledby="heading5" data-parent="#accordionExample">
                    <div class="card-body">
                        En cuanto a librerías de frontend he usado Materializ y Bootstrap.
                    </div>
                </div>
            </div>
        </div>
