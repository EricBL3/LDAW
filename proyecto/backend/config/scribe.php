...
return [
     ...
     */
    'description' => 'Documentación del API de JuegosLDAW',
        ...
        [
            ...
            'apply' => [
                ...
                'response_calls' => [
                     ...
                     * List the methods here or use '*' to meSan all methods. Leave empty to disable API calls.
                     */
                    'methods' => ['GET'],
    ...
    'auth' => [
         ...
         */
        'extra_info' => 'You can retrieve your token by signing in to the application.',
    ],
